                                  ...
                                  <div class="input-field col s7 offset-s1">
                                      <div class="file-field">
                                            ...
                                            <div class="file-path-wrapper">
                                              <input name="path" class="file-path validate" type="text">
                                            </div>
                                        </div>
                                  </div>
                                  <div class="input-field col s4">
                    ...
                    <div class="aside aside2 z-depth-barts">
                     ...
                     <div class="row">
                         <div class="col s12">
                             <div class="row">
                                    <h5>Employee List</h5>
                                    <ul class="collapsible z-depth-0" data-collapsible="accordion" ng-init="emp=[{name:'Han Ainan',lastname:'Ongsip'},{name:'John Angelo',lastname:'Barot'},{name:'Joshua',lastname:'Mercado'}]">
